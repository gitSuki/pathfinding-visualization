...
const initGridWidth = Math.round(screen.width / 27.5);
const initStartNodeCol = Math.round((screen.width / 30) * 0.2);
const initEndNodeCol = Math.round((screen.width / 30) * 0.8);
